...
- Updated dependencies [c438934]
    - @stratify/stratify-api@1.1.0
...
- Updated dependencies [7b085c2]
    - @stratify/stratify-api@0.9.1

## 0.12.4

### Patch Changes

- 525e7d5: Use Link component in AppNavbar and PublicNavbar to navigate to the dashboard or homepage

## 0.12.3

### Patch Changes

- db949ea: - Fix displaying of page titles on all screens by ensuring they span the full width and align to the left instead of being centered
