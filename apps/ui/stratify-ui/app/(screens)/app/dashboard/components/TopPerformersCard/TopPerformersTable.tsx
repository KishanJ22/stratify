...
import type { AssetType } from "../../../markets/MarketDataTable/MarketDataTable";
import type { Investment } from "../../../portfolios/components/InvestmentsTable/InvestmentsTable";
import { useSessionContext } from "../../../SessionProvider";
import type { TopPerformersCardProps } from "./TopPerformersCard";
	...
	const data = isPortfoliosNotFoundError
		...
		: isInvestmentsNotFoundError
			...
			: hasNoPositiveReturns
				? noInvestmentsData(
						translate(
							"Dashboard.topPerformers.noTopPerformersFound",
						),
					)
