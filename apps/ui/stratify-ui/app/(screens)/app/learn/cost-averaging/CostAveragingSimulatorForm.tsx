...
import type { AddTradeErrorResponse } from "../../portfolios/hooks/useAddTrade";
import {
	type CostAveragingSimulatorSchema,
	...
	const form = useAppForm({
		...
		onSubmit: async ({ value }) => {
			...
			const requestBody = {
				...
				timePeriodYears: parseInt(value.timePeriodYears, 10),
	...
	useEffect(() => {
		if (formValues.totalInvestment && formValues.timePeriodYears) {
			const totalContributions =
				parseInt(formValues.timePeriodYears, 10) *
