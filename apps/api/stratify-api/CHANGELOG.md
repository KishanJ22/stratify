...
- 7b085c2: Fix calculation of the total value of all portfolios by summing up the investments in all portfolios instead of summing up the value of each portfolio (used in the portfolio value history endpoint)
