...
def test_get_most_active_success(mock_app, mocker):
    ...
    mocker.patch("src.routes.market.most_active_get.query_funds_by_activity", return_value=[mock_fund_quote_data])
...
def test_get_most_active_no_data(mock_app, mocker):
    ...
    mocker.patch("src.routes.market.most_active_get.query_funds_by_activity", return_value=[])
